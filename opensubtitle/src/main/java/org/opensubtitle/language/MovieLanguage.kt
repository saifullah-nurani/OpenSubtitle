...
@StringDef(
    MovieLanguage.AFGHANISTAN, MovieLanguage.ALBANIA, MovieLanguage.ALGERIA, MovieLanguage.AMERICAN_SAMOA,
    MovieLanguage.ANDORRA, MovieLanguage.ANGOLA, MovieLanguage.ANGUILLA, MovieLanguage.ANTARCTICA,
    MovieLanguage.ANTIGUA_AND_BARBUDA, MovieLanguage.ARGENTINA, MovieLanguage.ARMENIA, MovieLanguage.ARUBA,
    MovieLanguage.AUSTRALIA, MovieLanguage.AUSTRIA, MovieLanguage.AZERBAIJAN, MovieLanguage.BAHAMAS,
    MovieLanguage.BAHRAIN, MovieLanguage.BANGLADESH, MovieLanguage.BELARUS, MovieLanguage.BELGIUM,
    MovieLanguage.BENIN, MovieLanguage.BERMUDA, MovieLanguage.BHUTAN, MovieLanguage.BOLIVIA,
    MovieLanguage.BOSNIA_AND_HERZEGOVINA, MovieLanguage.BOTSWANA, MovieLanguage.BRAZIL,
    MovieLanguage.BRITISH_VIRGIN_ISLANDS, MovieLanguage.BRUNEI, MovieLanguage.BULGARIA,
    MovieLanguage.BURKINA_FASO, MovieLanguage.BURMA, MovieLanguage.BURUNDI, MovieLanguage.CAMBODIA,
    MovieLanguage.CAMEROON, MovieLanguage.CANADA, MovieLanguage.CAPE_VERDE, MovieLanguage.CAYMAN_ISLANDS,
    MovieLanguage.CHAD, MovieLanguage.CHILE, MovieLanguage.CHINA, MovieLanguage.COLOMBIA, MovieLanguage.CONGO,
    MovieLanguage.COSTA_RICA, MovieLanguage.COTE_D_IVOIRE, MovieLanguage.CROATIA, MovieLanguage.CUBA,
    MovieLanguage.CYPRUS, MovieLanguage.CZECH_REPUBLIC, MovieLanguage.CZECHOSLOVAKIA,
    MovieLanguage.DEMOCRATIC_REPUBLIC_OF_CONGO, MovieLanguage.DENMARK, MovieLanguage.DJIBOUTI,
    MovieLanguage.DOMINICA, MovieLanguage.DOMINICAN_REPUBLIC, MovieLanguage.EAST_GERMANY, MovieLanguage.ECUADOR,
    MovieLanguage.EGYPT, MovieLanguage.EL_SALVADOR, MovieLanguage.EQUATORIAL_GUINEA, MovieLanguage.ESTONIA,
    MovieLanguage.ETHIOPIA, MovieLanguage.FAROE_ISLANDS, MovieLanguage.FINLAND, MovieLanguage.FRANCE,
    MovieLanguage.GABON, MovieLanguage.GAMBIA, MovieLanguage.GEORGIA, MovieLanguage.GERMANY, MovieLanguage.GHANA,
    MovieLanguage.GREECE, MovieLanguage.GREENLAND, MovieLanguage.GUATEMALA, MovieLanguage.GUINEA,
    MovieLanguage.GUINEA_BISSAU, MovieLanguage.HAITI, MovieLanguage.HONDURAS, MovieLanguage.HONG_KONG,
    MovieLanguage.HUNGARY, MovieLanguage.ICELAND, MovieLanguage.INDIA, MovieLanguage.INDONESIA, MovieLanguage.IRAN,
    MovieLanguage.IRAQ, MovieLanguage.IRELAND, MovieLanguage.ISRAEL, MovieLanguage.ITALY, MovieLanguage.JAMAICA,
    MovieLanguage.JAPAN, MovieLanguage.JORDAN, MovieLanguage.KAZAKHSTAN, MovieLanguage.KENYA, MovieLanguage.KOREA,
    MovieLanguage.KOSOVO, MovieLanguage.KUWAIT, MovieLanguage.KYRGYZSTAN, MovieLanguage.LAOS, MovieLanguage.LATVIA,
    MovieLanguage.LEBANON, MovieLanguage.LESOTHO, MovieLanguage.LIBERIA, MovieLanguage.LIBYA, MovieLanguage.LITHUANIA,
    MovieLanguage.LUXEMBOURG, MovieLanguage.MACAU, MovieLanguage.MACEDONIA, MovieLanguage.MADAGASCAR,
    MovieLanguage.MALAWI, MovieLanguage.MALAYSIA, MovieLanguage.MALDIVES, MovieLanguage.MALI, MovieLanguage.MALTA,
    MovieLanguage.MARSHALL_ISLANDS, MovieLanguage.MARTINIQUE, MovieLanguage.MAURITANIA, MovieLanguage.MAURITIUS,
    MovieLanguage.MEXICO, MovieLanguage.MOLDOVA, MovieLanguage.MONACO, MovieLanguage.MONGOLIA,
    MovieLanguage.MONTENEGRO, MovieLanguage.MOROCCO, MovieLanguage.MOZAMBIQUE, MovieLanguage.MYANMAR,
    MovieLanguage.NAMIBIA, MovieLanguage.NEPAL, MovieLanguage.NETHERLANDS, MovieLanguage.NEW_ZEALAND,
    MovieLanguage.NICARAGUA, MovieLanguage.NIGER, MovieLanguage.NIGERIA, MovieLanguage.NORTH_KOREA,
    MovieLanguage.NORWAY, MovieLanguage.OMAN, MovieLanguage.PAKISTAN, MovieLanguage.PALESTINE, MovieLanguage.PANAMA,
    MovieLanguage.PARAGUAY, MovieLanguage.PERU, MovieLanguage.PHILIPPINES, MovieLanguage.POLAND, MovieLanguage.PORTUGAL,
    MovieLanguage.QATAR, MovieLanguage.ROMANIA, MovieLanguage.RUSSIA, MovieLanguage.RWANDA, MovieLanguage.SAUDI_ARABIA,
    MovieLanguage.SENEGAL, MovieLanguage.SERBIA, MovieLanguage.SINGAPORE, MovieLanguage.SLOVAKIA,
    MovieLanguage.SLOVENIA, MovieLanguage.SOMALIA, MovieLanguage.SOUTH_AFRICA, MovieLanguage.SOUTH_KOREA,
    MovieLanguage.SPAIN, MovieLanguage.SRI_LANKA, MovieLanguage.SUDAN, MovieLanguage.SURINAME, MovieLanguage.SWAZILAND,
    MovieLanguage.SWEDEN, MovieLanguage.SWITZERLAND, MovieLanguage.SYRIA, MovieLanguage.TAIWAN, MovieLanguage.TANZANIA,
    MovieLanguage.THAILAND, MovieLanguage.TOGO, MovieLanguage.TONGA, MovieLanguage.TRINIDAD_AND_TOBAGO,
    MovieLanguage.TUNISIA, MovieLanguage.TURKEY, MovieLanguage.UGANDA, MovieLanguage.UKRAINE,
    MovieLanguage.UNITED_ARAB_EMIRATES, MovieLanguage.UNITED_KINGDOM, MovieLanguage.UNITED_STATES, MovieLanguage.URUGUAY,
    MovieLanguage.UZBEKISTAN, MovieLanguage.VENEZUELA, MovieLanguage.VIETNAM, MovieLanguage.YEMEN,
    MovieLanguage.ZAMBIA, MovieLanguage.ZIMBABWE
)
